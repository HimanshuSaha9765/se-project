...
use App\Models\User;
use App\Repository\DealerPaymentRepo;
use Carbon\Carbon;
use Exception;
...
class DealerPaymentService implements DealerPaymentRepo
{
    var $compact_data;
    ...
    public function manage_payment()
    {
        try {
            ...
            $payment = payment_log::query()->where('consumer_number', $d_data);

            $consumer_number_Of_client_documentsTable = Client_Document::query()->where('consumer_number', $d_data)->first();
