...
return new class extends Migration
{
    ...
    {
        Schema::create('structure_stocks', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('structure_id')->references('info_id')->on('structures');
        });
    }
    ...
    {
        Schema::dropIfExists('structure_stocks');
    }
};
