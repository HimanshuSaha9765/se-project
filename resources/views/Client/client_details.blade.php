            ...
            <div class="x_panel">
                ...
                <div class="x_content  mx-4">
                    @if (empty($Client_Document_Data) || empty($Client_Document_Data->consumer_number))
                        <a href="{{ URL::to('admin/') }}/add_client_document/?authUser={{ $consumer_number }}">
                            <h6 class="mb-2">
                    ...
                    {{-- <a href="{{ route('admin.download_document_and_update') }}"> --}}
                    <a href="{{ URL::to('admin/') }}/download_document_and_update/?authUser={{ $consumer_number }}">
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
                            <span style="font-size: 15px">Download And Update Documents</span>
                        </h6>
                    </a>
                    {{-- <a href="{{ route('admin.manage_payment') }}"> --}}
                    <a href="{{ URL::to('admin/') }}/manage_payment/?authUser={{ $consumer_number }}">
                        {{-- <a href="{{ URL::to('admin/') }}/add_payment/?authUser={{ $consumer_number }}"> --}}
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
        ...
        <div class="col-sm-6 col-xl-4 p-2">
            <div class="x_panel">
                ...
                <div class="x_content p-2  mx-4">
                    <a href="{{ URL::to('admin/') }}/add_client_tracking/?authUser={{ $consumer_number }}">
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
                            Add Client Tracking
                        </h6>
                    ...
                    <a href="{{ URL::to('admin/') }}/add_material/?authUser={{ $consumer_number }}">
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
                            <span style="font-size: 15px">Add Material</span>
                        </h6>
                    </a>
                    <a href="{{ URL::to('admin/') }}/material_report/?authUser={{ $consumer_number }}">
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
                                        ...
                                        <div class="horizontal-timeline">
                                            <ul class="list-inline items">
                                                ...
                                                <li
                                                    ...
                                                    <p class="py-1 px-2 rounded mt-3">Structure Details</p>
                                                </li>
                                                ...
                                                <li
                                                    class="list-inline-item items-list @if (
                                                        $Client_tracking_Data->inverter_image7 ||
                                                            $Client_tracking_Data->serial_number_image7 ||
                                                            $Client_tracking_Data->serial_number7) active @endif">
                                                    <p class="py-1 px-2 rounded mt-3">
                                                        Inverter
                                                    </p>
                                                </li>
                                                <li
                                                    class="list-inline-item items-list @if ($Client_tracking_Data->perform_8 || $Client_tracking_Data->form_16_8) active @endif">
                                                    <p class="py-1 px-2 rounded mt-3">
                                                        Meter Installation
                                                    </p>
                                                </li>
                                                ...
                                                <li
                                                    class="list-inline-item items-list @if (
                                                        $Client_tracking_Data->jr_form_9 ||
                                                            $Client_tracking_Data->subsidy_clamp_9 ||
                                                            $Client_tracking_Data->amount_9 ||
                                                            $Client_tracking_Data->description_9 ||
                                                            $Client_tracking_Data->recived_9 ||
                                                            $Client_tracking_Data->pdf_9) active @endif">
