                            ...
                            <div class="col-md-12 col-sm-6 col-xs-12">
                                <div class="p-2">
                                    <div class="mt-2">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col-sm-4 col-xs-12">
                                                                ...
                                                                @php
                                                                    ...
                                                                    $payment_first->Client_Document->variation_amount;
                                                                    // $maxFinalConfirmAmount =
                                        ...
                                        @endif
                                        <a
                                            href="{{ $admin ? URL::to('admin/') . '/add_payment/?authUser=' . $consumer_number : '' }}">
