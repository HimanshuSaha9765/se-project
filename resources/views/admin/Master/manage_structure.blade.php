    ...
    <div class="x_panel">
        <div class="x_content">
            <div style="display: flex; justify-content: flex-end;">
                <button type="button" class="btn btn-outline-dark" data-toggle="modal" data-target="#structureModal"
                    data-whatever="@mdo">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="structureTableModalLabel">Add Structure</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form id="AddStructureForm" method="POST" action="{{ route('admin.insert_structure') }}">
                            @csrf
            ...
            {{-- EDIT MODAL --}}
            <div class="modal fade" id="structureEditModal" tabindex="-1" role="dialog"
                aria-labelledby="structureModalEditLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="structureTableModalLabel">Edit Structure</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form id="EditStructureForm" method="POST" action="{{ route('admin.update_structure') }}">
                            @csrf
                            <div class="modal-body">
            ...
            {{-- INFO MODAL --}}
            <div class="modal fade bs-example-modal-lg" id="structureInfoModal" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <tbody>
                                @foreach ($structures as $structure)
                                    <tr>
                                            ...
                                            <div>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                    <button class="dropdown-item edit-btn" type="button"
                                                        data-id="{{ $structure->id }}"> <i class="fa fa-edit mx-2"></i>
                                                        Edit</button>
                                                    ...
                                                    <button id="info" class="dropdown-item" type="button"
                                                        data-id="{{ $structure->info_id }}" data-toggle="modal"
                                                        data-target="#structureInfoModal">
                                        ...
                                        <td>{{ $structure->accessories_name ?? '-' }}</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.table').on('click', '.edit-btn', function(e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url: '{{ route('admin.edit_structure', ['id' => ':id']) }}'
                        .replace(':id', id),
                    type: "GET",
            ...
            var editForm = $("#EditStructureForm");
            ...
            $(document).on('change', '.toggle-status', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{ route('admin.update_structure_status', ['id' => ':id', 'status' => ':status']) }}'
            ...
            $(document).on('click', '#delete_btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('admin.delete_structure', ['id' => ':id']) }}'
                                .replace(':id', structureId),
                            type: 'GET',
                            success: function(response) {
                                // Swal.fire({
