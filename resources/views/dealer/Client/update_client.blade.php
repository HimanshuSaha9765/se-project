...
@section('content')
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form action="{{ route('dealer.update_client') }}" method="POST" enctype="multipart/form-data"
                id="updateclientForm">
                @csrf
                <div class="row my-2">
                ...
                <div class="row my-2">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter KW" id="kw1" class="form-control number_field"
                            name="kw" value="{{ $client->kw }}" required />
                        <span style="color:red">
                            @error('kw')
                                {{ $message }}
                            @enderror
                ...
                <div class="row my-4">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="text" id="reference_by_fatch1" class="form-control p-1" name="reference_by_fatch"
                            value="{{ $User_data->name }} - {{ $User_data->city_name }}" readonly />
                        <input type="text" id="reference_by1" class="form-control p-1" name="reference_by"
                            value="{{ $User_data->email_assign  }}" hidden />
                ...
                <div class="row my-4">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <label for="structure_image1" class="required_input">Select Structure Image</label>
