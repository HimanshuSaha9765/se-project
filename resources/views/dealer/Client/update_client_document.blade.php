...
@section('content')
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form action="{{ route('dealer.update_client_document') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row my-2">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <label for="adharcard_number1" class="required_input">Adharcard Number</label>
                ...
                <div class="row my-4">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <img style="width: 100%; display: block;"
                            ...
                            height="200" />
                        <label for="adharcard_image1" class="required_input">Select Adharcard</label>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <label for="light_bill1" class="required_input">Select Light Bill</label>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <img style="width: 100%; display: block;" src="{{ asset('images/' . $document_data->text_bill) }}"
                            alt="image" width="100" height="200" />
                        <label for="text_bill1" class="required_input">Select Text Bill</label>
                ...
                <div class="row my-4">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <label for="passport_size_image1" class="required_input">Select Passport Size Image</label>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <img style="width: 100%; display: block;" src="{{ asset('images/' . $document_data->pancard) }}"
                            alt="image" width="100" height="200" />
                        <label for="pancard1" class="required_input">Select Pancard</label>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <img style="width: 100%; display: block;"
                            ...
                            height="200" />
                        <label for="bank_proof1" class="required_input">Select Bank proof (Cancel Cheque)</label>
                ...
                <div class="row my-4">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <label for="final_confirm_amount1" class="required_input">Final Confirm Amount</label>
