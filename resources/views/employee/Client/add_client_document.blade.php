...
@section('content')
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form action="{{ route('employee.insert_client_document') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row my-2">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text" id="consumer_number1" class="form-control" name="consumer_number"
                            value="{{ $consumer_number }}" readonly />
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter Adharcard Number" id="adharcard_number1"
                            class="form-control" name="adharcard_number" value="{{ old('adharcard_number') }}"
                            maxlength="12" />
                        <span style="color:red">
                ...
                <div class="row my-4">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="file" id="adharcard_image1" class="form-control p-1" name="adharcard_image"
                            value="{{ old('adharcard_image') }}" onchange="validateImage(this)" />
                        <span style="color:red">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="file" id="light_bill1" class="form-control p-1" name="light_bill"
                            value="{{ old('light_bill') }}" onchange="validateImage(this)" />
                        <span style="color:red">
                            @error('light_bill')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="file" id="text_bill1" class="form-control p-1" name="text_bill"
                            value="{{ old('text_bill') }}" onchange="validateImage(this)" />
                        <span style="color:red">
                            @error('text_bill')
                                {{ $message }}
                            @enderror
                ...
                <div class="row my-4">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="file" id="passport_size_image1" class="form-control p-1" name="passport_size_image"
                            value="{{ old('passport_size_image') }}" onchange="validateImage(this)" />
                        <span style="color:red">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="file" id="pancard1" class="form-control p-1" name="pancard"
                            value="{{ old('pancard') }}" onchange="validateImage(this)" />
                        <span style="color:red">
                            @error('pancard')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="file" id="bank_proof1" class="form-control p-1" name="bank_proof"
                            value="{{ old('bank_proof') }}" onchange="validateImage(this)" />
                        <span style="color:red">
                            @error('bank_proof')
                                {{ $message }}
                            @enderror
                ...
                <div class="row my-4">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter Final Confirm Amount" id="final_confirm_amount1"
                            ...
                            value="{{ $Client_Data->quotation_amount ?? '0' }}" />
                        <span style="color:red">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text" id="deposit1" class="form-control input-field" name="deposit"
                            placeholder="Enter Deposit" value="{{ old('deposit') }}" />
                        <span style="color:red">
                            @error('deposit')
                                {{ $message }}
                            @enderror
                ...
                <div class="row my-4">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="text" id="due_amount1" class="form-control input-field" name="due_amount"
                            value="{{ $Client_Data->quotation_amount ?? '0' }}" readonly />
                    </div>
                </div>
