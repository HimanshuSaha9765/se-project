            ...
            <div class="x_panel">
                ...
                <div class="x_content  mx-4">
                    ...
                    @if (empty($Client_Document_Data) || empty($Client_Document_Data->consumer_number))
                        <a href="{{ URL::to('employee/') }}/add_client_document/?authUser={{ $consumer_number }}">
                            <h6 class="mb-2">
                    ...
                    <a href="{{ URL::to('employee/') }}/download_document_and_update/?authUser={{ $consumer_number }}">
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
                    ...
                    <a href="{{ URL::to('employee/') }}/manage_payment/?authUser={{ $consumer_number }}">
                        {{-- <a href="{{ URL::to('employee/Client') }}/add_payment/?authUser={{ $consumer_number }}"> --}}
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
        ...
        <div class="col-sm-6 col-xl-4 p-2">
            <div class="x_panel">
                ...
                <div class="x_content p-2  mx-4">
                    <a href="{{ URL::to('employee/') }}/add_client_tracking/?authUser={{ $consumer_number }}">
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
                            Add Client Tracking
                        </h6>
                    ...
                    <a href="{{ URL::to('employee/') }}/employee_add_material/?authUser={{ $consumer_number }}">
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
                            <span style="font-size: 15px">Add Material</span>
                        </h6>
                    </a>
                    <a href="{{ URL::to('employee/') }}/employee_material_report/?authUser={{ $consumer_number }}">
                        <h6 class="mb-2">
                            <i class="fa fa-angle-right mx-2"></i>
