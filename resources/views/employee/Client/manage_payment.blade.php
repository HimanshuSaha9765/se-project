                            ...
                            <div class="col-md-12 col-sm-6 col-xs-12">
                                <div class="p-2">
                                    <div class="mt-2">
                                                    ...
                                                    @if ($payment_first->consumer_number == decrypt(request('authUser')))
                                                        <div class="row align-items-center">
                                                            <div class="col-sm-4 col-xs-12">
                                                                ...
                                                                @php
                                                                    $maxFinalConfirmAmount = $payment->max(
                                                                        'final_confirm_amount',
                                                                    );
                                                                    // $maxFinalConfirmAmount =
                                                                    //     $payment_first->final_confirm_amount;
                                                                @endphp
                                                            ...
                                                            @if ($Payment2->total_amount > $maxFinalConfirmAmount)
                                                                {{-- <li class="list-group-item text-warning"
                                                                    ...
                                                                    Total Amount : {{ $Payment2->due_amount ?? '-' }}</li> --}}

                                                                    <div class="col-sm-4 col-xs-12">
                                                                        <h2 class="d-block text-warning" for="cvv">
                                        ...
                                        <a
                                            href="{{ URL::to('employee/') }}/add_payment/?authUser={{ $consumer_number }}">
                                    ...
                                    <div style="background:#eff4f8;border-radius:16px;">
                                        <div class="p-4">
                                            <table class="w-100" id="cartTable">
                                                ...
                                                @if ($payment->payment_mode == 'cash')
                                                    <tr>
                                                        ...
                                                        <td><strong>{{ $payment->payment_date ?? '-' }}</strong></td>
                                                    </tr>
                                                    <tr style="border-bottom: 1px solid black">
                                                        <td><span class="text-secondary">Payment Type</span></td>
                                                        <td style="text-transform: capitalize">
                                                            <strong>{{ $payment->payment_mode ?? '-' }}<strong>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><span class="text-secondary">Deposite Amount</span></td>
                                                        <td><strong
                                                                style="color: limegreen">{{ $payment->Client_Document->deposit ?? '-' }}</strong>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><span class="text-secondary">Various Amount</span></td>
                                                        <td><strong
                                                                style="color: limegreen">{{ $payment->various_amount ?? '0' }}</strong>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><span class="text-secondary">Recieved Amount</span></td>
                                                        <td><strong
                                                                style="color: limegreen">{{ $payment->amount ?? '-' }}</strong>
                                                        </td>
                                                    </tr>
                                                @endif
                                                ...
                                                @if ($payment->payment_mode == 'cheque')
                                                    ...
                                                    <tr>
                                                        <td><span class="text-secondary">Bank Name</span></td>
                                                        <td style="text-transform: uppercase">
                                                            <strong>{{ $payment->bank_name ?? '-' }}</strong>
                                                        </td>
                                                    </tr>
                                                    <tr style="border-bottom: 1px solid black">
                                                        <td><span class="text-secondary">Cheque Number</span></td>
                                                ...
                                                @if ($payment->payment_mode == 'online')
                                                    ...
                                                    <tr>
                                                        <td><span class="text-secondary">Type of payment</span></td>
                                                        <td style="text-transform: uppercase">
                                                            <strong>{{ $payment->type_of_payment ?? '-' }}</strong>
                                                        </td>
                                                    </tr>
                                                    <tr style="border-bottom: 1px solid black">
                                                        <td><span class="text-secondary">Transaction Number</span></td>
                                            ...
                                            <div style="display: flex;justify-content: space-between">
                                                <h4><span class="text-secondary">Total</span></h4>
                                                <h5><strong class="text-primary">₹
                                                        {{ $payment->total_amount ?? ($payment->Client_Document->deposit ?? '0') }}</strong>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="p-4 text-center" style="background:#eff4f8;border-radius:16px;">
                                        <h4 style="font-weight: 600">Payment Not Added Yet.</h4>
                                    </div>
                                @endif
                            </div> --}}
                        </div>
