...
@section('content')
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form action="{{ route('employee.update_client') }}" method="POST" enctype="multipart/form-data" id="updateclientForm">
                @csrf
                <div class="row my-2">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter Client Name" id="client_name1" class="form-control"
                            name="client_name" value="{{ $client->name }}" required>
                        <span style="color:red">
                            @error('client_name')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter Mobile Nmber" id="mobile_number1" class="form-control number_field"
                            name="mobile_number" value="{{ $client->mobile_number }}" required maxlength="10"/>
                        <span style="color:red">
                            @error('mobile_number')
                                {{ $message }}
                            @enderror
                ...
                <div class="row my-2">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter Running Bill Amount" id="bill_amount1" class="form-control number_field"
                            name="bill_amount" value="{{ $client->bill_amount }}"  />
                        <span style="color:red">
                            @error('bill_amount')
                                {{ $message }}
                            @enderror
                ...
                <div class="row my-4">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter Structure Length" id="structure_length1"
                            class="form-control number_field" name="structure_length" value="{{ $client->structure_length }}"/>
                        <span style="color:red">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter Structure Width" id="structure_width1" class="form-control number_field"
                            name="structure_width" value="{{ $client->structure_width }}"  />
                        <span style="color:red">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter Structure Height" id="structure_height1"
                            class="form-control number_field" name="structure_height" value="{{ $client->structure_height }}"/>
                        <span style="color:red">
                ...
                <div class="row my-4">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="text" placeholder="Enter Final Quotation Amount" id="quotation_amount1"
                            class="form-control number_field" name="quotation_amount" value="{{ $client->quotation_amount }}"/>
                        <span style="color:red">
                        ...
                        <select class="form-control select2" id="reference_by1" name="reference_by" style="width: 100%"
                            ...
                            @foreach ($User_data as $user_ref_name)
                                <option value="{{ $user_ref_name->email_assign }}"
                                    @if ($client->reference_by == $user_ref_name->name) selected @endif>
                                    {{ $user_ref_name->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <textarea id="address1" class="form-control" name="address"
                            placeholder="Enter Customer Address">{{ $client->address }}</textarea>
                        <span style="color:red">
                            @error('address')
                                {{ $message }}
                            @enderror
