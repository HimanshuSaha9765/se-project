                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        ...
                        <div class="profile_info">
                            ...
                            @php
                                use App\Models\User;
                                $email_employee = session()->get('employee');
                                $employee_data = User::query()->where('email', $email_employee)->first();
                            @endphp
                            <h2>
                                @if ($employee_data)
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                ...
                                <li class="{{ request()->routeIs('employee.manage_client') ? 'active ' : '' }}">
                                    <a href="{{ route('employee.manage_client') }}"><i class="fa fa-user"></i>
                                        Client </a>
                                </li>
                                <li class="{{ request()->routeIs('employee.employee_manage_stock') ? 'active ' : '' }}">
                                    <a href="{{ route('employee.employee_manage_stock') }}">
