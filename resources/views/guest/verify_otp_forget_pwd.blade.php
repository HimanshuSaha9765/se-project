...
@section('content')
    ...
    <div class="container bg-light overflow-hidden card text-center flex" style="max-width: 30rem; margin-top: 130px">
        <h2 style="margin-top: 20px;" class="text-primary ">OTP</h2>
        <svg width="250" height="200" viewBox="0 0 292 208" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1_45)">
                ...
                <path
                    ...
                    fill="#91E4FF" />
                <path d="M192.608 92.382H169.544C166.21 92.382 163.508 89.68 163.508 86.3461V64.4241L192.608 92.382Z"
                    fill="#0CB4EA" />
                <path
                ...
                <path
                    ...
                    fill="white" />
                <rect x="233.582" y="79" width="10" height="10" rx="1" transform="rotate(27.2727 233.582 79)"
                    fill="#91A3FF" />
            ...
            <rect x="274" y="47.0925" width="10" height="10" rx="1" transform="rotate(-24.1576 274 47.0925)"
                fill="#FF9191" />
            <rect y="68.5666" width="10" height="10" rx="1" transform="rotate(-27.1716 0 68.5666)"
                fill="#91A3FF" />
        ...
        <div class="contact card-body flex">
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-12 contact-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div>
                        <div class="pt-4 pb-2">
                            <h4 class="card-title text-center pb-0 fs-4 text-primary">Verification Code</h4>
                            <p class="text-center small">We have sent a verification code to your email address</p>
                        </div>
                        <form action="{{ route('guest.verify_forget_pwd_otp_action') }}" method="POST"
                            id="AddForgotPasswordOTPForm">
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="otp" class="form-control number_field" id="otp" name="otp"
                                            placeholder="otp" autocomplete="off" maxlength="6" minlength="6" required>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            var addForm = $("#AddForgotPasswordOTPForm");
            addForm.validate({
                errorElement: 'span',
