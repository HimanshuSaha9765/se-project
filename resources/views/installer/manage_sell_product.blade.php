...
@section('content')
    @php
        ...
        $installer = session()->has('installer');
    @endphp
    ...
    <div class="x_panel">
        <div class="x_content">
            ...
            {{-- <div style="display: flex; justify-content: flex-end;">
                <a
                    href="
            @if ($admin) {{ route('admin.add_client') }} @endif
            @if ($employee) {{ route('employee.add_client') }} @endif
            @if ($dealer) {{ route('dealer.add_client') }} @endif
            ">
                        ...
                        <table id="clientTable" class="table table-bordered  table-hover text-nowrap text-center"
                            ...
                            <tbody>
                                @foreach ($clients as $client)
                                    <tr>
                                        <td><a href="{{ URL::to('installer/') }}/client_stock_details/{{ $client->consumer_number }}"
                                        ...
                                        {{-- <td>
                                            <a href="{{ asset('images/' . $client->structure_image) }}" download><img
                                                    src="{{ URL::to('/') }}/images/{{ $client->structure_image }}"
